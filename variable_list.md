...
57. **location_prob**: The model-assigned probability for the label in column 56. Empty if assigned location is UNK. 
...
59. **contender_location_prob**: The model-assigned probability for the contender location in column 58.
